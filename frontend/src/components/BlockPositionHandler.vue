	...
	<div class="flex w-full flex-col items-center gap-5">
		...
		<div class="grid-rows grid grid-cols-3 gap-4" v-if="showHandler">
			...
			>
				...
				></div>
				<div
					class="col-span-3 row-start-3 h-2 w-[2px] self-center justify-self-center rounded-4 bg-surface-gray-2"
				></div>
				<div class="h-5 w-5 self-center justify-self-center rounded-4 bg-surface-gray-5"></div>
				<div
					class="col-span-1 col-start-1 row-start-2 h-[2px] w-2 self-center justify-self-center rounded-4 bg-surface-gray-2"
				></div>
				<div
					class="col-span-1 col-start-3 row-start-2 h-[2px] w-2 self-center justify-self-center rounded-4 bg-surface-gray-2"
				></div>
			</div>
