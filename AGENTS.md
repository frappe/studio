...
When migrating existing page variables to scripts, follow
[the migration guide](studio/studio/doctype/studio_page/patches/migrate_variables_to_page_script.md).
